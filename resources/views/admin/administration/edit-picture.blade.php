<x-main>
                    ...
                    <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                ...
                                <span class="nav-text font-size-lg">Arrière plan</span>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <h6 class="text-dark font-weight-bold mb-10">Logo:</h6>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Group-->
                                ...
                                @php
                                    $image = asset("images/logo/".$logo);
                                    $route = route('logo.update');
                                @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="row">
                                    <label class="col-3"></label>
                                    <div class="col-9">
                                        <h6 class="text-dark font-weight-bold mb-10">Arrière plan:</h6>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Group-->
                                @php
                                    $imageBackground = asset("images/background/".$background);
                                    $route = route('background.update');
                                @endphp
                                <form class="cmxform avatar" id="updateForm" method="post"
                                      action="{{$route}}" enctype='multipart/form-data' data-module="profile">
                                    @csrf
                                    @method("PUT")
                                    <div class="form-group row avatar ">
                                        <label class="col-form-label col-3 text-lg-right text-left"></label>
                                        <x-image-slim data-label="Placer votre background ici" data-size="240,240"
                                                      data-ratio="1:1" :image="$imageBackground" name="photo"
                                                      remove-date="removeBackground"/>
                                    </div>
                                    <!--end::Group-->
                                    <!--begin::Group-->
    ...
    <x-slot name="jsSlot">
        ...
        <script>
            function removeLogo(data, remove) {
                if (window.confirm("Are you sure?")) {
                    remove();
                }
            }

            function removeBackground(data, remove) {
                if (window.confirm("Are you sure?")) {
                    remove();
                }
            }
